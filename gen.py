...
class task:
	def __init__(self, t_id, et, dep, rt, status, a_time, s_time, f_time):
		...
		self.a_time = a_time # Task allocation time
...
def graph_predef(bench_name):
	...
	for i in range(num_tasks):
		task_list.append(task(i, None, [], None, None, None, None, None))
