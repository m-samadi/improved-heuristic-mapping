...
def export_scheduling(num_threads, queue, alg_name, par1, par2):
	...
	if par1 == '':
		file = open("output/scheduling/" + alg_name.lower() + ".dat", "w")
	else:
		if alg_name == 'heuristic':
			file = open("output/scheduling/" + par1.lower() + "-" + par2.lower() + ".dat", "w")
		else:
			file = open("output/scheduling/i-" + par1.lower() + "-" + par2.lower() + ".dat", "w")
...
def graphic_result(num_threads, queue, t, alg_name, par1, par2):
	...
	# Create the output file #
	if par1 == '':
		im.save('output/graphic/' + alg_name.lower() + '.jpg', quality = 300)
	else:
		if alg_name == 'heuristic':
			im.save('output/graphic/' + par1.lower() + '-' + par2.lower() + '.jpg', quality = 300)
		else:
			im.save('output/graphic/i-' + par1.lower() + '-' + par2.lower() + '.jpg', quality = 300)
