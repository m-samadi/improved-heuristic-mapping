...
# heuristic.py
#
# Perform task-to-thread mapping in OpenMP using the heuristic mapping
...
def execute(num_tasks, num_threads, task_list, deadline, alloc_alg, disp_alg, graphic_result):
	...
	func.export_scheduling(num_threads, exec_queue, 'heuristic', alloc_alg, disp_alg)

	# Draw the graphical output #
	if graphic_result == 1:
		func.graphic_result(num_threads, exec_queue, t, 'heuristic', alloc_alg, disp_alg)
